	...
	<body>
		...
		<div class="w">
			...
			<div id="addManager" class="content1">
				...
				<div id="greybg">
					<ul>
						<form action="productType.servlet?action=deleteFirstType" method="post">
							<li>
							 删除一级分类
								选择删除的大分类：
								<select id="firstType3" name="firstType3" class="select">
									<option value="-1">
										请选择一级分类
									</option>
						...
						<form action="productType.servlet?action=deleteSecondType" method="post">
							<li>
								删除二级分类
								<br>
								选择要删除的二级分类：
